...
public class GetCSVReport extends HttpServlet {
private static final Logger log = Logger.getLogger(GetCSVReport.class.getName());
...
//					}
					...
					sb.append("<tr><td>"+"Реден број" +
							"</td><td>"+"Име"  +
							"</td><td>"+"Презиме"  +
							"</td><td>"+"Пол"  +
							"</td><td>"+"Дата на Раѓање" +
							"</td><td>"+"Националност" +
							"</td><td>"+"Друга Националност" +
							"</td><td>"+"Име на таткото" +
							"</td><td>"+"Име на мајката"+
							"</td><td>"+"Моминско име на Мајката"+
							"</td><td>"+"Број на наод"+
							"</td><td>"+"Дата на наод"+
//							","+drugidijagnoziT+
//							","+merki+
...
//							","+zabeleshki+
					...
					sb.append("<tr><td>"+redenbr +
							"</td><td>"+fname  +
							"</td><td>"+last  +
							"</td><td>"+pol  +
							"</td><td>"+dob +
							"</td><td>"+nacionalnost +
							"</td><td>"+druganacionalnost +
							"</td><td>"+imenatatkoto +
							"</td><td>"+imenamajkata+
							"</td><td>"+mominskamajka+
							"</td><td>"+baodbroj+
